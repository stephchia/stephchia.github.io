...
I designed and delivered five lectures centered on blue crabs (an iconic species for Marylanders), using a case study approach to introduce key concepts in population dynamics, including population structure, species interactions, spatial dynamics, harvesting, and climate change. This includes an in-class [R tutorial](/blog/2024/population-matrix/) that allows students to apply these concepts to explore fishery policy options. These lectures were later integrated into the regular curriculum.
