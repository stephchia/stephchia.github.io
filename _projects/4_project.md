...
- **Altitudinal migration of birds**: Using eBird data to characterize seasonal elevational movement of 100+ resident bird species in Taiwan, we found that the majority of species tend to shift elevation across seasons, likely driven by thermal tolerance and food availability. ([Tsia et al. 2021](https://doi.org/10.1111/ecog.05196))
